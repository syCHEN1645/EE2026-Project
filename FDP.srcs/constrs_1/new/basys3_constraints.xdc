...
## Clock signal
set_property -dict { PACKAGE_PIN W5   IOSTANDARD LVCMOS33 } [get_ports BASE_CLOCK]
create_clock -add -name sys_clk_pin -period 10.00 -waveform {0 5} [get_ports BASE_CLOCK]
